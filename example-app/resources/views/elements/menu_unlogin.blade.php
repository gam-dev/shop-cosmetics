        ...
        <div class="col-12">
            <nav
                ...
                <div class="container-fluid px-0">
                    ...
                    <a href="./login"
                        class="btn btn-sm  bg-gradient-primary  btn-round mb-0 ms-auto d-lg-none d-block">Đăng
                        nhập</a>
                    ...
                    <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                                    ...
                                    <div class="d-none d-lg-block">
                                        <ul class="list-group">
                                            <li
                                                ...
                                                <a class="dropdown-item py-2 ps-3 border-radius-md" href="./nuochoa">
                                                    <div class="d-flex">
                                            ...
                                            <li
                                                class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                                <a class="dropdown-item py-2 ps-3 border-radius-md" href="./sonmoi">
                                                    <div class="d-flex">
                                                        <div class="icon h-10 me-3 d-flex mt-1">
                                            ...
                                            <li
                                                class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                                                <a class="dropdown-item py-2 ps-3 border-radius-md" href="./kem">
                                                    <div class="d-flex">
                                                        <div class="icon h-10 me-3 d-flex mt-1">
                        ...
                        <ul class="navbar-nav d-lg-block d-none">
                            <li class="nav-item">
                                <a href="./login" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1"
